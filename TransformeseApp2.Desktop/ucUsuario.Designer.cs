namespace TransformeseApp2.Desktop
{
    partial class ucUsuario
    {
        ...
        private void InitializeComponent()
        {
            ...
            pbFoto.CustomizableEdges = customizableEdges1;
            ...
            txtNome.Location = new Point(3, 168);
            ...
            txtUsuario.Location = new Point(5, 233);
            ...
            btnCadastrar.Location = new Point(3, 347);
            ...
            btnAtualizar.Location = new Point(108, 347);
            ...
            btnExcluir.Location = new Point(211, 347);
            ...
            txtPesquisa.Location = new Point(312, 57);
            ...
            dgUsuario.ColumnHeadersHeight = 4;
            ...
            dgUsuario.GridColor = Color.FromArgb(231, 229, 255);
            dgUsuario.Location = new Point(314, 99);
            ...
            dgUsuario.ThemeStyle.AlternatingRowsStyle.SelectionBackColor = Color.Empty;
            dgUsuario.ThemeStyle.AlternatingRowsStyle.SelectionForeColor = Color.Empty;
            dgUsuario.ThemeStyle.BackColor = SystemColors.ButtonHighlight;
            dgUsuario.ThemeStyle.GridColor = Color.FromArgb(231, 229, 255);
            dgUsuario.ThemeStyle.HeaderStyle.BackColor = Color.FromArgb(100, 88, 255);
            dgUsuario.ThemeStyle.HeaderStyle.BorderStyle = DataGridViewHeaderBorderStyle.None;
            dgUsuario.ThemeStyle.HeaderStyle.Font = new Font("Segoe UI", 9F);
            dgUsuario.ThemeStyle.HeaderStyle.ForeColor = Color.White;
            dgUsuario.ThemeStyle.HeaderStyle.HeaightSizeMode = DataGridViewColumnHeadersHeightSizeMode.EnableResizing;
            dgUsuario.ThemeStyle.HeaderStyle.Height = 4;
            dgUsuario.ThemeStyle.ReadOnly = false;
            dgUsuario.ThemeStyle.RowsStyle.BackColor = Color.White;
            dgUsuario.ThemeStyle.RowsStyle.BorderStyle = DataGridViewCellBorderStyle.SingleHorizontal;
            dgUsuario.ThemeStyle.RowsStyle.Font = new Font("Segoe UI", 9F);
            dgUsuario.ThemeStyle.RowsStyle.ForeColor = Color.FromArgb(71, 69, 94);
            dgUsuario.ThemeStyle.RowsStyle.Height = 25;
            dgUsuario.ThemeStyle.RowsStyle.SelectionBackColor = Color.FromArgb(231, 229, 255);
